...
class CheckingFragment : Fragment() {
    ...
    private var confirmedPnrs = ArrayList<String>()
    private var scannedPnrs = ArrayList<String>()

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)

        val scanButton = view.findViewById<View>(R.id.btn_scan_check)
        ...
        val clear_button = view.findViewById<Button>(R.id.btn_scan_checking_clear)
        clear_button.setOnClickListener {
            val table = view.findViewById<TableLayout>(R.id.stepwise_tab_table)
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.fragment_stepwise, container, false)
    }
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, intent: Intent) {
        ...
        if (scanningResult != null) {
            ...
            // send received data
            parentActivity.updateUiWithScannedQrData(codeContent, R.id.stepwise_tab_table, view, context)
        }
    }
